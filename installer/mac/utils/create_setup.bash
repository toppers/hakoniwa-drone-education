...
# 環境変数の定義
DYLD_LIBRARY_PATH_VAR="${TOP_DIR}/lib/hakoniwa:${TOP_DIR}/lib/hakoniwa/py"
...
add_to_setup "PYTHONPATH" "${SRC_PATH}:\$PYTHONPATH"
add_to_setup "PYTHONPATH" "${SRC_PATH}/drone_evaluation:\$PYTHONPATH"
add_to_setup "PYTHONPATH" "${SRC_PATH}/drone_evaluation/components:\$PYTHONPATH"
