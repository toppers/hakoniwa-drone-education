...
if __name__ == '__main__':
    ...
    parser.add_argument('--uptime', type=int, default=100, help='グラフ描画間隔。単位はmsecです')
    ...
    parser.add_argument('--p', type=str, default='PID_ALT_SPD_Kp', help='Pゲインのパラメータ名')
    parser.add_argument('--i', type=str, default='PID_ALT_SPD_Ki', help='Iゲインのパラメータ名')
    parser.add_argument('--d', type=str, default='PID_ALT_SPD_Kd', help='Dゲインのパラメータ名')
